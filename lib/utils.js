var utils = {
	...
	*/
	...
	MakeView: function (cameraX, cameraY, cameraZ, elev, ang) {
		// Creates in {out} a view matrix. The camera is centerd in ({cameraX}, {cameraY}, {cameraZ}).
		...
		T = this.MakeTranslateMatrix(-cameraX, -cameraY, -cameraZ);
